...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>Floris | Search Generic</title>
					...
					<div class="log-body" style="margin-top: 100px;">
						<form action="" method="POST">
							<table class="log-table" cellspacing="0">
								<tr>
									<td align="center" style="padding: 0px 0px 10px 0px;"><h1>Search Generic</h1></td>
								</tr>
								<tr>
									<td class="bs-example">
								...
								<tr>
									<td style="height: 23px;">
										<span>
											...
											?>
															<script type="text/javascript">
																location.href="search_generic_result.php?generic_id=<?php echo $row['generic_id'] ?>";
															</script>
											<?php 
