...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>Floris | Remove Medicine</title>
					...
					<div class="log-body" style="margin-top: 100px;">
						<form action="" method="POST">
							<table class="log-table" cellspacing="0">
								<tr>
									<td align="center" style="padding: 0px 0px 10px 0px;"><h1>Delete Medicine</h1></td>
								</tr>
								<tr>
									<td class="bs-example">
											...
											<?php 
												...
												if(isset($_REQUEST['submit'])==true) {
													if(!empty($_REQUEST['medicine_name'])==true) {
														...
														if($count>=1) {
															$sql_d="DELETE FROM medicines WHERE medicine_name='$medicine_name'";
															mysqli_query($con,$sql_d); 
											?>
															<script type="text/javascript">
																alert('Medicine Deleted!');
																location.href="remove_medicine.php";
															</script>
											<?php
														}
														else {
