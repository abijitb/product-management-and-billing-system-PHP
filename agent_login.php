...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>Floris | Agent Log in</title>
			...
			<div class="sidebar">
				...
				<div class="menu">
					<ul>
						...
						<li><a href="agent_login.php" style="color: #ff9800;">Agent log in</a></li>
					</ul>
				</div>
			</div>
			<!-- END SIDEBAR -->
					...
					<div class="log-body" style="margin-top: 100px;">
						<form id="login_form" name="login_form" method="post">
							<table class="log-table" cellspacing="0">
								<tr>
									<td align="center" style="padding: 0px 0px 10px 0px;"><h1>Agent Log in</h1></td>
								</tr>
								<tr>
									<td><input type="text" name="agent_username" id="agent_username" placeholder="Username"></td>
								</tr>
								<tr>
									<td><input type="password" name="agent_password" id="agent_password" placeholder="Password"></td>
								</tr>
								<tr>
								...
								<tr>
									<td style="padding: 8px 0px 0px 0px;" class="header-link">Forgot Password? <a href="agent_forgot.php">Click Here</a></td>
								</tr>
							</table>
						</form>
					</div>
